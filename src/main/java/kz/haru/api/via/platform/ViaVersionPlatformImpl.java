...
import kz.haru.api.via.platform.viaversion.ViaAPIWrapper;
import kz.haru.api.via.platform.viaversion.ViaConfig;
import kz.haru.api.via.util.ViaTask;
...
public class ViaVersionPlatformImpl implements ViaPlatform<UUID>, IMinecraft {
    ...
    public ViaVersionPlatformImpl(Logger logger) {
        this.logger = logger;
        this.config = new ViaConfig(new File(ViaLoadingBase.getInstance().getRunDirectory(), "esckere.yml"));
    }
    ...
    public String getPlatformName() {
        return "Esckere by " + ClientInfo.clientName;
    }
