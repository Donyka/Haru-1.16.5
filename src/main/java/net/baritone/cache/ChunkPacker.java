...
package net.baritone.cache;

import net.baritone.api.utils.BlockUtils;
import net.baritone.pathing.movement.MovementHelper;
import net.baritone.utils.pathing.PathingBlockType;
...
import static net.baritone.utils.BlockStateInterface.getFromChunk;
