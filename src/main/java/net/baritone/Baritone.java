...
import net.baritone.api.event.listener.IEventBus;
import net.baritone.api.utils.Helper;
import net.baritone.api.utils.IPlayerContext;
import net.baritone.behavior.*;
import net.baritone.cache.WorldProvider;
import net.baritone.command.manager.CommandManager;
import net.baritone.event.GameEventHandler;
import net.baritone.process.*;
import net.baritone.selection.SelectionManager;
import net.baritone.utils.BlockStateInterface;
import net.baritone.utils.GuiClick;
import net.baritone.utils.InputOverrideHandler;
import net.baritone.utils.PathingControlManager;
import net.baritone.utils.player.PrimaryPlayerContext;
 ...
 * @since 7/31/2018
 */
public class Baritone implements IBaritone, IMinecraft {
    ...
    static {
        ...
        dir = new File(mc.gameDir, "baritone");
