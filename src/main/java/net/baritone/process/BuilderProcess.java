...
package net.baritone.process;

import net.baritone.Baritone;
import net.baritone.api.pathing.goals.Goal;
import net.baritone.api.pathing.goals.GoalBlock;
import net.baritone.api.pathing.goals.GoalComposite;
import net.baritone.api.pathing.goals.GoalGetToBlock;
import net.baritone.api.process.IBuilderProcess;
import net.baritone.api.process.PathingCommand;
import net.baritone.api.process.PathingCommandType;
import net.baritone.api.schematic.FillSchematic;
import net.baritone.api.schematic.ISchematic;
import net.baritone.api.schematic.IStaticSchematic;
import net.baritone.api.schematic.SubstituteSchematic;
import net.baritone.api.schematic.format.ISchematicFormat;
import net.baritone.api.utils.BetterBlockPos;
import net.baritone.api.utils.RayTraceUtils;
import net.baritone.api.utils.Rotation;
import net.baritone.api.utils.RotationUtils;
import net.baritone.api.utils.input.Input;
import net.baritone.pathing.movement.CalculationContext;
import net.baritone.pathing.movement.Movement;
import net.baritone.pathing.movement.MovementHelper;
import net.baritone.utils.BaritoneProcessHelper;
import net.baritone.utils.BlockStateInterface;
import net.baritone.utils.PathingCommandContext;
import net.baritone.utils.schematic.MapArtSchematic;
import net.baritone.utils.schematic.SchematicSystem;
import net.baritone.utils.schematic.SelectionSchematic;
import net.baritone.utils.schematic.format.defaults.LitematicaSchematic;
import net.baritone.utils.schematic.litematica.LitematicaHelper;
import net.baritone.utils.schematic.schematica.SchematicaHelper;
...
import static net.baritone.api.pathing.movement.ActionCosts.COST_INF;
...
public final class BuilderProcess extends BaritoneProcessHelper implements IBuilderProcess {
    ...
    private OptionalInt hasAnyItemThatWouldPlace(BlockState desired, RayTraceResult result, Rotation rot) {
        for (int i = 0; i < 9; i++) {
            ...
            float originalYaw = ctx.player().packetYaw;
            float originalPitch = ctx.player().packetPitch;
            // the state depends on the facing of the player sometimes
            ctx.player().packetYaw = rot.getYaw();
            ctx.player().packetPitch = rot.getPitch();
            ...
            ctx.player().packetYaw = originalYaw;
            ctx.player().packetPitch = originalPitch;
