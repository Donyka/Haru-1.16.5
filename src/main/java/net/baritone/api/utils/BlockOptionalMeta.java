...
import net.baritone.api.utils.accessor.IItemStack;
...
public final class BlockOptionalMeta {
    ...
    public static LootTableManager getManager() {
        if (manager == null) {
            try (ResourcePackList rpl = new ResourcePackList(ResourcePackInfo::new, new ServerPackFinder())) {
                rpl.reloadPacksFromFinders();
                IResourcePack thePack = rpl.getAllPacks().iterator().next().getResourcePack();
                try (IReloadableResourceManager resourceManager = new SimpleReloadableResourceManager(ResourcePackType.SERVER_DATA)) {
