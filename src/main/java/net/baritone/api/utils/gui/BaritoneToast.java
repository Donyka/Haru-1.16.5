...
package net.baritone.api.utils.gui;
...
public class BaritoneToast implements IToast {
    ...
    public static void addOrUpdate(ITextComponent title, ITextComponent subtitle) {
        addOrUpdate(net.minecraft.client.Minecraft.getInstance().getToastGui(), title, subtitle, net.baritone.api.BaritoneAPI.getSettings().toastTimer.value);
    }
}
