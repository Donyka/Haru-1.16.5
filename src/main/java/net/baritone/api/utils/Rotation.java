...
package net.baritone.api.utils;
...
public class Rotation implements IMinecraft {
     ...
     */
    public float getYaw() {
    	IBaritone baritone = BaritoneAPI.getProvider().getBaritoneForPlayer((ClientPlayerEntity) (Object) mc.player);
    	
    	//if (baritone.getMineProcess().isActive() || baritone.getFollowProcess().isActive())
    	//	mc.player.rotationYaw = this.yaw;
    	YAW = correctRotation(yaw , pitch).x;
    ...
    public float getPitch() {
    	...
    	PITCH = correctRotation(yaw, pitch ).y;
        return PITCH;
    }
