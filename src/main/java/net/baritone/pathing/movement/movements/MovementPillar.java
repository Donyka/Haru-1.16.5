...
package net.baritone.pathing.movement.movements;
...
import net.baritone.api.utils.VecUtils;
...
import net.baritone.pathing.movement.MovementState;
...
public class MovementPillar extends Movement {
    ...
    public MovementState updateState(MovementState state) {
        ...
        Rotation rotation = RotationUtils.calcRotationFromVec3d(ctx.playerHead(),
                ...
                new Rotation(ctx.player().packetYaw, ctx.player().packetPitch));
        if (!ladder) {
            state.setTarget(new MovementState.MovementTarget(new Rotation(ctx.player().packetYaw, rotation.getPitch()), true));
        }
