...
package net.baritone.pathing.movement;
...
import net.baritone.pathing.movement.MovementState.MovementTarget;
import net.baritone.pathing.precompute.Ternary;
import net.baritone.utils.BlockStateInterface;
import net.baritone.utils.ToolSet;
...
import static net.baritone.pathing.movement.Movement.HORIZONTALS_BUT_ALSO_DOWN_____SO_EVERY_DIRECTION_EXCEPT_UP;
import static net.baritone.pathing.precompute.Ternary.*;
    ...
    static void moveTowards(IPlayerContext ctx, MovementState state, BlockPos pos) {
        state.setTarget(new MovementTarget(
                new Rotation(RotationUtils.calcRotationFromVec3d(ctx.playerHead(),
                        ...
                        ctx.playerRotations()).getYaw(), ctx.player().packetPitch),
                false
