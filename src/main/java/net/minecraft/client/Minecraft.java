...
import net.baritone.api.event.events.WorldEvent;
...
public class Minecraft extends RecursiveEventLoop<Runnable> implements ISnooperInfo, IWindowEventListener
{
    ...
    {
        StringBuilder stringbuilder = new StringBuilder(ClientInfo.clientName);
    ...
    public void displayGuiScreen(@Nullable Screen guiScreenIn)
    {
        ...
        else
        {
            ...
            this.mouseHelper.grabMouse(true);
        }
    ...
    public void runTick()
    {
        if (player != null && world != null) {
            Haru.getInstance().getEventManager().callEvent(new MTickEvent());
        }
