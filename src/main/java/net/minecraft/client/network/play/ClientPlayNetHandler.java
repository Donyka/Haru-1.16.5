...
import net.baritone.api.event.events.ChunkEvent;
...
public class ClientPlayNetHandler implements IClientPlayNetHandler
{
    ...
    public void handleMultiBlockChange(SMultiBlockChangePacket packetIn)
    {
        ...
        if (!Baritone.settings().repackOnAnyBlockChange.value && Haru.baritoneAviable()) {
            return;
        }
        ...
        if (entity != null)
        {
            ...
            else if (packetIn.getOpCode() == 35)
            {
                ...
                if (entity == this.client.player) {
                    RemovalsEvent event = new RemovalsEvent(RemovalsEvent.CancelRender.TOTEM);
