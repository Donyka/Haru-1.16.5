...
public class IngameGui extends AbstractGui
{
    ...
    {
        Haru.getInstance().getEventManager().callEvent(new Render2DEvent(matrixStack, partialTicks, Render2DEvent.RenderLayer.FIRST));
        Haru.getInstance().getEventManager().callEvent(new Render2DEvent(matrixStack, partialTicks, Render2DEvent.RenderLayer.SECOND));
        ...
        if (InterfaceModule.get().isEnabled() && !InterfaceModule.get().elements.is("Potion")){
