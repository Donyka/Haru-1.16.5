...
public class MultiplayerScreen extends Screen
{
    ...
    private final VersionSelectorElement viaScreen = Haru.getInstance().getViaMCP().viaScreen;
    ...
    protected void init()
    {
        ...
        this.addButton(Haru.getInstance().getViaMCP().viaScreen);
    ...
    {
        super.tick();
        Haru.getInstance().getViaMCP().viaScreen.tick();
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks)
    {
        ...
        Haru.getInstance().getViaMCP().viaScreen.render(matrixStack, mouseX, mouseY, partialTicks);
    }
