...
//        }, button$itooltip))).active = flag;
        ...
        this.addButton(new Button(this.width / 2 - 100, yIn + rowHeightIn * 2, 200, 20, ITextComponent.getTextComponentOrEmpty("Alt Manager"), (p_lambda$addSingleplayerMultiplayerButtons$4_1_) ->
        {
            this.minecraft.displayGuiScreen(new Haru().getAltManagerScreen());
        }));
    }
