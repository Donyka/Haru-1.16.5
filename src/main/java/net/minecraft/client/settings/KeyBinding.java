...
import kz.haru.implement.events.player.movement.SprintEvent;
...
public class KeyBinding implements Comparable<KeyBinding>
{
    ...
    public static void updateKeyBindState()
    {
        ...
        boolean sprintEventCancelled = false;

        if (mc.player != null) {
            SprintEvent event = new kz.haru.implement.events.player.movement.SprintEvent();
            Haru.getInstance().getEventManager().callEvent(event);
            sprintEventCancelled = event.isCancelled();
        }
        ...
        for (KeyBinding keybinding : KEYBIND_ARRAY.values())
        {
            ...
            {
                if (sprintEventCancelled && keybinding == mc.gameSettings.keyBindSprint) {
